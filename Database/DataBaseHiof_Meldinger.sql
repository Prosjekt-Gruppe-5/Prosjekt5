...
CREATE TABLE `Meldinger` (
  `idMeldinger` int NOT NULL,
  `Tekst` varchar(100) NOT NULL,
  `idEmne` int NOT NULL,
  `idStudenter` int NOT NULL,
  PRIMARY KEY (`idMeldinger`),
  KEY `idEmne` (`idEmne`),
  KEY `idStudenter` (`idStudenter`),
  CONSTRAINT `meldinger_ibfk_1` FOREIGN KEY (`idEmne`) REFERENCES `Emner` (`idEmne`),
  CONSTRAINT `meldinger_ibfk_2` FOREIGN KEY (`idStudenter`) REFERENCES `Studenter` (`idStudenter`)
