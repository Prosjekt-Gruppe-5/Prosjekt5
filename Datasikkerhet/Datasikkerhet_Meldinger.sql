...
CREATE TABLE `Meldinger` (
  ...
  `Meldingstekst` varchar(100) NOT NULL,
  `Svar` varchar(45) DEFAULT NULL,
  `Emne_id` int NOT NULL,
  PRIMARY KEY (`Melding_id`),
  KEY `Emne_id` (`Emne_id`),
  CONSTRAINT `meldinger_ibfk_1` FOREIGN KEY (`Emne_id`) REFERENCES `Emner` (`Emne_id`)
...
-- Dump completed on 2021-02-02 14:43:49
